...
_FEATURE = constant.STATE
_FEATURE_AUTOCOMPLETE = Autocomplete.atc_state_name

class STATE_MAIN(Cog_Extension):
...
async def setup(bot:Bot):await bot.add_cog(STATE_MAIN(bot))