...
_FEATURE = constant.SKILL
_FEATURE_AUTOCOMPLETE = Autocomplete.atc_skill_name

class SKILL_MAIN(Cog_Extension):
...
async def setup(bot:Bot):await bot.add_cog(SKILL_MAIN(bot))