...
class TRAIT_BASE(Cog_Extension):
    def __init_subclass__(cls,feature):
        ...
        def auto_register(func):setattr(cls,_FEATURE+func.__name__,func);return func

        @cls._group.command(name=constant.ADD,description=constant.ADD+_FEATURE)
        @auto_register
        @Check.is_gm()
        ...
        @cls._group.command(name=constant.CHANGE,description=constant.CHANGE+_FEATURE)
        @auto_register
        @Check.is_gm()
        @app_commands.describe(
            target = _FEATURE,
        ...
        @cls._group.command(name=constant.DELETE,description=constant.DELETE+_FEATURE)
        @auto_register
        @Check.is_gm()
        @app_commands.describe(
            target = _FEATURE,
        ...
        @cls._group.command(name=constant.SHOW,description=constant.SHOW+_FEATURE)
        @auto_register
        @app_commands.describe(
            target = _FEATURE,
        )
        ...
        @cls._group.command(name=constant.GIVE,description=constant.GIVE+_FEATURE)
        @auto_register
        @app_commands.describe(
            target = _FEATURE,
            role = constant.ROLE,
        ...
        @cls._group.command(name=constant.REMOVE,description=constant.REMOVE+_FEATURE)
        @auto_register
        @app_commands.describe(
            target = _FEATURE,
            role = constant.ROLE,
        ...
        @cls._group.command(name=constant.MIX,description=constant.MIX+_FEATURE)
        @auto_register
        @app_commands.describe(
